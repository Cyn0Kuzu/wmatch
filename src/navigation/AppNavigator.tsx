      ...
      <Tab.Screen 
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <Text style={{ fontSize: focused ? 24 : 20, color: focused ? '#E50914' : color }}>🎬</Text>
          ),
        }}
      />
      <Tab.Screen 
        ...
        options={{
          tabBarLabel: 'Match',
          tabBarIcon: ({ color, focused }) => (
            <Text style={{ fontSize: focused ? 24 : 20, color: focused ? '#E50914' : color }}>❤️</Text>
          ),
        }}
      />
      <Tab.Screen 
