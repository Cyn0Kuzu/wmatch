          ...
          <View style={styles.viewersSection}>
            <View style={styles.viewersAvatars}>
              {item.viewers.slice(0, 5).map((viewer, idx) => {
                // Get profile photo - prioritize profilePhotos array, then photoURL
                const profilePhoto = (viewer.profilePhotos && Array.isArray(viewer.profilePhotos) && viewer.profilePhotos.length > 0)
                  ? viewer.profilePhotos[0]
                  : viewer.photoURL || null;
                
                const displayName = viewer.displayName || viewer.firstName || viewer.name || viewer.username || '?';
                
                return (
                  <View key={`${viewer.id}-${idx}`} style={[styles.viewerAvatar, idx > 0 && styles.viewerAvatarOverlap]}>
                    {profilePhoto ? (
                      <Image
                        key={`photo-${viewer.id}-${idx}-${profilePhoto}`}
                        source={{ uri: profilePhoto }}
                        style={styles.viewerAvatarImage}
                        resizeMode="cover"
                        onError={() => {
                          console.log('Failed to load profile photo for viewer:', viewer.id);
                        }}
                      />
                    ) : (
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.filterContainer}>
            ...
            >
              <View style={styles.filterButtonContent}>
                <Icon name={Icons.movie} size={16} color={watchingFilter === 'movie' ? '#E50914' : '#FFFFFF'} />
            ...
            >
              <View style={styles.filterButtonContent}>
                <Icon name={Icons.tv} size={16} color={watchingFilter === 'tv' ? '#E50914' : '#FFFFFF'} />
          ...
          {filteredCurrentlyWatching.length > 0 ? (
            ...
            <View style={styles.emptyWatchingContainer}>
              <Icon name={Icons.tv} size={48} color="#8C8C8C" />
        ...
        <View style={styles.searchSection}>
          ...
          >
            <Icon name={Icons.search} size={20} color="#8C8C8C" style={styles.searchIcon} />
            <TextInput
              ...
              onBlur={() => {
                // Close filter buttons when search bar loses focus
                if (!searchQuery) {
            ...
            {searchExpanded && searchQuery && (
              ...
              >
                <Icon name={Icons.close} size={18} color="#CCCCCC" />
              </TouchableOpacity>
            )}
          </TouchableOpacity>
            ...
            <View style={styles.searchCategoryButtons}>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  <Icon name={Icons.movie} size={16} color={searchCategory === 'movie' ? '#E50914' : '#FFFFFF'} />
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  <Icon name={Icons.tv} size={16} color={searchCategory === 'tv' ? '#E50914' : '#FFFFFF'} />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                <Icon name={Icons.search} size={20} color="#E50914" />
        ...
        <View style={styles.section}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 }}>
            <Icon name={Icons.movie} size={20} color="#E50914" />
        ...
        <View style={styles.section}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 }}>
            <Icon name={Icons.trophy} size={20} color="#E50914" />
        ...
        <View style={styles.section}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 }}>
            <Icon name={Icons.tv} size={20} color="#E50914" />
